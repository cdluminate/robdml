...
Random & \uline{53.9} & \uline{3.8} & 27.4 & 32.9 & \multicolumn{2}{c|}{Collapse} & \multicolumn{2}{c|}{Collapse} & \multicolumn{2}{c|}{Collapse}\tabularnewline
\hline 
...
\hline 
Hardest &  &  &  &  &  &  &  &  & \uline{48.9} & \uline{5.0}\tabularnewline

	\bottomrule
\end{tabular}
}

\caption{Hardness Manipulation: Source hardness v.s. Destination hardness for
amdsemi on CUB Dataset. (R@1, ERS for each cell). Diagonal = does
not attack}
\label{tab:desth}
