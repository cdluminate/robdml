...
\end{tabular}
	...
	%
	Experiments are conducted on CUB Dataset with RN18 model.
	%
	The last-epoch performance is reported instead of the peak performance.
	%
	Original data is used when the source and destination hardness are the
	same, as shown on the diagonal line of the table.
	%
}
	\label{tab:desth}
