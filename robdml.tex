...
sample triplet and increase its hardness into a specified hardness level.
%
...
which stops halfway at the specified hardness level.
%
But, how hard should such ``specified level'' be?
