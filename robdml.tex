...
%
The parameter $u$ is equal to $\gamma$, much less than the upperbound of the
loss function, in order to avoid excessive hardness boost in pseudo-hardness
functions $g_\mathsf{B}$ and $g_\mathsf{LGA}$.
