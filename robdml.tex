...
\begin{figure}[t]
	...
	\caption{
		...
		between Our Method (\ie, ``HM'') and the State-of-The-Art Method (\ie, ``ACT'').
		%
...
sampler, based on the approximated mean hardness of their outputs, as shown
in~\cref{tab:hsort}.
%
Then we adversarially train models on the CUB dataset with all combinations
respectively, and summarize the R@1 and ERS performance in \cref{tab:desth}.
