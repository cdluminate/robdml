...
sampling method, can be selected for source and destination hardness,
not all combinations are effective and efficient.
%
In this subsection, we find a proper combination empirically.
