...
semihard~\cite{facenet}, softhard~\cite{revisiting}, distance~\cite{distance}, and the hardest
negative sampling (\ie, the negative sample with the largest loss value).
%
...
destination hardness, we adversarially train RN18 models on the CUB dataset with
