...
$\eta+1$.}, as well as the R@1 performance on benign examples to reflect the
...
R@1, but is much less efficient in gaining robustness.
%
...
%
As a result, ACT's ERS with a small $\eta$ is relatively low.
