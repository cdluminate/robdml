...
strategy (\eg, Random) within a mini-batch, we define its \emph{hardness} as a
scalar which is within $[-2,2]$:
%
\begin{equation}
%
...
triplet'', and its corresponding hardness value as ``\emph{source}
hardness'', denoted as $H_\mathsf{S}$.
