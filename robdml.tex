...
\oo{regular and max can be expressed as two boundary cases of HM}
...
Our core contribution is the improvement in adversarial training efficiency
through HM.
%
Since regular training and the min-max adversarial training can be expressed
as two boundary cases as HM, Graduate Adversary is modeled as an ``intermediate
hardness'' the two cases.
%
Enforcing the previously neglected Intra-Class Structure is also beneficial
for model robustness and adversarial training efficiency.
