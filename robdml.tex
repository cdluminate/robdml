...
collapse.
%
In the classical min-max adversarial training, the adversarial example triplet
created by maximizing the triplet loss value can incur model collapse more
easily than unperturbed sample triplets.
%



In this paper, we propose Hardness Manipulation (HM) to create adversarial
