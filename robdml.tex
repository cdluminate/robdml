...
%
We speculate the  \oo{TODO}
The $E[H]$ of distance and hardest sampling are empirically observed very close.
%

And the model can be easier to collapse with adversarially perturbed hard
examples
