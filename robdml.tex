...
recognition~\cite{facenet,domainface}, as well as a wide impact in
...
%
Such vulnerability raises safety, security, and fairness concerns in the
applications of DML.
%
For example, impersonation or recognition evation are possible for DML-based
face-identification system.
%
To counter the attacks (\ie, mitigating the vulnerability), it is important to
