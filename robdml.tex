...
\textbf{Destination Hardness} $H_\mathsf{D}$.
%
$\text{HM}[H_\mathsf{S},H_\mathsf{D}]$ is a very flexible method as various
\emph{destination} hardness $H_\mathsf{D}$ can be used, \eg, a constant, the
...
\emph{source} triplet, the adversary may become weak in the late phase of
training.
%
The training process of the model aims to reduce the expectation of triplet loss
$E[L_\text{T}]$ to zero over the distribution of sample triplets,
and thus the $E[H]$ of any given triplet will eventually tend to $-\gamma$,
reducing the hardness of adversarial triplets from HM.
