...
%
Furthermore, advertsarial training already suffers from
significant training time cost (compared to the normal training process).
%
Hence, time efficiency in gaining adversarial robustness is an inevitable
major issue.

We conjecture there is a certain intermediate level of hardness.

notable penalty in the model performance on benign (\ie, unperturbed) examples.
