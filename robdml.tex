...
It must be acknowledged that the high R@1 performance of our method largely
stems from the source triplet sampling strategy, namely Softhard, instead of
our contribution.
%
Our core contribution is

minimizing a slightly different objective than the triplet loss.
