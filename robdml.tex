...
Thus, a desired $H_\mathsf{D}$ should be (1) close to $H_\mathsf{S}$ in the
...
pseudo-hardness functions.

Additionally, if we have a strong prior knowledge on ``how hard the destination
hardness should be'', the pseudo-hardness function can be independent from any
benign triplet.
