...
methods~\cite{nes-atk,spsa-atk} and transferrability-based methods~[], which
are more practical for real-world scenarios.
...
results~[][][], or covertly alter the top-ranking results without being
abnormal~[][][][].
