...
\noindent\textbf{A:}
%
They have same complexity polynomials in terms of time and space.
%
...
%
Triplet sampler is aligned in the table for identical
sampling complexities.
%
Omitting the identical terms, the rest complexity stems from adversarial perturbation objective functions and loss function.
%
The reported values are uneasy to compare for future work as they are sensitive
to hardware, software, and programming tricks.
%
The paragraph will be provided in the next revision.
