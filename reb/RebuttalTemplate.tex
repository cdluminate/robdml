...
%
Triplet sampler is aligned to ``Softhard'' in the table for identical
sampling complexities, and hence omitted.
%
The rest complexities stem from adversarial perturbation objective functions.
%
Note, the values are sensitive to factors including hardware, software, and
