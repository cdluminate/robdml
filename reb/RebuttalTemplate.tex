...
\textbf{A:} Thanks for the suggestion. In order to make the table easier to
...
caption; (3) highlight the columns for imporant performance metrics; (4)
colorize the text abbreviations for different methods in the same way as the
corresponding colored legends in the figures. 
