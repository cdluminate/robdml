...
\cline{2-18} \cline{3-18} \cline{4-18} \cline{5-18} \cline{6-18} \cline{7-18} \cline{8-18} \cline{9-18} \cline{10-18} \cline{11-18} \cline{12-18} \cline{13-18} \cline{14-18} \cline{15-18} \cline{16-18} \cline{17-18} \cline{18-18}
 & EST{[}$\mathcal{R}${]} & 8 & 37.1 & 47.3 & 20.0 & 46.4 & 0.5 & 97.3 & 0.5 & 91.3 & 0.875 & 1.325 & 3.9 & 0.4 & 14.9 & 0.0 & 7.9\tabularnewline
...
\cline{2-18} \cline{3-18} \cline{4-18} \cline{5-18} \cline{6-18} \cline{7-18} \cline{8-18} \cline{9-18} \cline{10-18} \cline{11-18} \cline{12-18} \cline{13-18} \cline{14-18} \cline{15-18} \cline{16-18} \cline{17-18} \cline{18-18}
 & EST{[}$\mathcal{R}${]} & 32 & 8.5 & 13.0 & 2.6 & 25.2 & 2.7 & 97.9 & 0.4 & 97.3 & 0.848 & 1.576 & 1.4 & 0.0 & 4.0 & 0.0 & 5.3\tabularnewline
