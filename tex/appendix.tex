...
~\newline\textbf{V. Overfitting Issue}

Actually overfitting is still observed for our method. Early stopping
is possibly going to bring performance gain at this point. But in order
to make comparison with previous works with controled variable, we did not
investigate into this in detail.
