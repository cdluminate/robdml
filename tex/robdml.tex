...
To this end, Gradual Adversary, a family of pseudo-hardness functions is
...
family.
%
As an example, we design a ``Linear Gradual Adversary'' (LGA)
...
\begin{enumerate}[nosep, noitemsep, leftmargin=*]
	...
	\item {\textit{Hardness Manipulation}} (HM) as a flexible and efficient
		...
		%
	\item \textit{Linear Gradual Adversary} (LGA) as a Gradual Adversary, \ie,
...
most effective
methods~\cite{bilateral,advtrain-triplet,benchmarking,smoothat,trades,robustwrn,weightperturb,featurescatter,currat,awp},
...
%
A satisfactory pseudo-hardness function is a ``Gradual Adversary''.
...
\else
{\scriptsize
\textbf{Acknowledgements.} This work was supported by the DARPA GARD Program
HR001119S0026-GARD-FP-052. We thank Kangfu Mei for helpful feedbacks.
}
\fi
