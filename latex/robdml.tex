...
\begin{figure}[t]
	\includegraphics[width=1.0\columnwidth]{introdiag.pdf}
	\caption{\oo{Diagram demonstrating the core idea}}
\end{figure}
...
defense for classification, existing defense methods for DML are also adversarial
training-based.

\oo{[Quick review of existing defense methods]}
EST~\cite{advrank} and ACT~\cite{robrank}. Their issues.
