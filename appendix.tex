...
%
As encouraged by the author guidelines, we briefly discuss the potential
societal impact of our work.
%
Adversarial attacks may raise \uline{security considerations} on deep learning
applications, and even cause negative effect.
%
...
%
Besides, although adversarial training is not \uline{environment-friendly} due
to its high training cost in GPU time, our study has significantly improved the
adversarial training efficiency compared to the previous works.
